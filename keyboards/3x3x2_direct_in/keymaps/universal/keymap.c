    ...
    switch (keycode) {
        ...
        case EM_WK:
            if (record->event.pressed) {
                ...
                // hyphen/dash "-"
                register_code(KC_LALT);
                tap_code(KC_KP_0); tap_code(KC_KP_4); tap_code(KC_KP_5);
                unregister_code(KC_LALT);
                ...
                // lowercase y
                register_code(KC_LALT);
                tap_code(KC_KP_0); tap_code(KC_KP_1); tap_code(KC_KP_2); tap_code(KC_KP_1);
                unregister_code(KC_LALT);
        ...
        case PW_TZR:
            if (record->event.pressed) {
                SEND_STRING("T");
                register_code(KC_LALT);
                tap_code(KC_KP_0); tap_code(KC_KP_1); tap_code(KC_KP_2); tap_code(KC_KP_2); // Alt+0122 for z
                unregister_code(KC_LALT);
                SEND_STRING("r125%%55");
            }
            return false;
